...
If you want to download for only your OS, checkout link below that currently <strong>V.0.4.1</strong>. After download, please checkout the latest resource files that maybe <strong>'game/**.rpa'</strong> on <a href="https://github.com/YGGDRASIL-STUDIO/Discouraged-Workers/tree/master/game" target="_blank">GitHUB</a>.
