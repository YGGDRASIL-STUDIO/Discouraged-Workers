...
당신의 OS에 맞는 버전만을 다운로드하고 싶다면 아래 2014년 12월 20일자 <strong>V.0.4.1</strong>링크를 이용하십시오. 다운로드한 후, 우리의 <a href="https://github.com/YGGDRASIL-STUDIO/Discouraged-Workers/tree/master/game" target="_blank">GitHUB</a>에서 최신 리소스 파일을 체크하십시오. 아마도 <strong>'game/**.rpa'</strong>일 겁니다.
