init:
    ...
    image tdw_sepia = LiveComposite((1920, 1080), (0, 0), im.Sepia('images/sin.webp'), (600, 0), im.Sepia('images/tdw.webp'))
    image slap_sepia = LiveComposite((1920, 1080), (0, 0), im.Sepia('images/room.webp'), (600, 0), im.Sepia('images/slap.webp'))
    image deep_sepia = LiveComposite((1920, 1080), (0, 0), im.Sepia('images/room.webp'), (800, 0), im.Sepia('images/deepkiss.webp'))
    ...
    image wimcj_system_hungry = LiveComposite((256, 256), (0, 0), 'wimcj_system_comment0_flip', (80, 70), Text('', font='gui/fonts/fontawesome.ttf', size=128))
    image wimcj_system_bulb = LiveComposite((256, 256), (0, 0), 'wimcj_system_comment0_flip', (140, 70), Text('', font='gui/fonts/fontawesome.ttf', size=128))
    image wimcj_system_bulb_black = LiveComposite((256, 256), (0, 0), 'wimcj_system_comment0_black_flip', (90, 70), Text('', font='gui/fonts/fontawesome.ttf', color='#000', size=128))
    image wimcj_system_question = LiveComposite((256, 256), (0, 0), 'wimcj_system_comment0', (88, 70), Text('', font='gui/fonts/fontawesome.ttf', size=128))
    image wimcj_system_question_black = LiveComposite((256, 256), (0, 0), 'wimcj_system_comment0_black', (88, 70), Text('', font='gui/fonts/fontawesome.ttf', size=128, color='#000'))
