...
init python:
    ...
    build.archive("solitaire", "all")
    build.archive("fimbulvetr", "all")
    build.archive("wimcj", "all")
    build.classify('**~', None)
    ...
    if persistent.steam is True:
        build.classify('game/mods/solitaire/**.**', 'solitaire')
        build.classify('game/mods/fimbulvetr/**.**', 'fimbulvetr')
        build.classify('game/mods/wimcj/**.**', 'wimcj')
    else:
