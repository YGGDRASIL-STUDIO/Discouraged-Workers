translate Spanish strings:
    ...
    new "Tecla de flecha izquierda: Curación, Tecla de flecha derecha: Onlooking"
    old "Left arrow key: Back home, Right arrow key: Road not taken"
    new "Tecla de flecha izquierda: De vuelta a casa, Tecla de flecha derecha: Camino no tomado"
    ...
    new "{image=gui/controllers/[persistent.controllers]/button_y.webp} Configuración"
    old "{image=gui/controllers/[persistent.controllers]/shoulder_l.webp} {size=86}Quit{/size}"
    new "{image=gui/controllers/[persistent.controllers]/shoulder_l.webp} Salir"
    old "{image=gui/controllers/[persistent.controllers]/button_select.webp} {size=86}Quit{/size}"
    new "{image=gui/controllers/[persistent.controllers]/button_select.webp} Salir"
    old "Track 1. Pandemic"
    new "01. Pandemia"
    old "Track 2. Sigh day"
    new "02. El día de la tristeza"
    old "Track 3. Mare tranquillitatis"
    new "03. El mar de la calma"
    old "Track 4. CCCanon"
    new "04. CCCanon"
    old "Track 5. Let's game"
    new "05. ¡Vamos a jugar!"
    old "Track 6. Peace"
    new "06. Paz"
    old "Track 7. Unknown mist"
    new "07. Niebla desconocida"
    old "Track 8. Lush garden"
    new "08. Exuberante jardín"
    old "Track 9. Jormungandr"
    new "09. Jörmungandr"
    old "Track 10. Nyx"
    new "10. Nix"
    old "Track 11. Summit showdown"
    new "11. Cumbre enfrentamiento"
    old "Track 12. Love song"
    new "12. Canción de amor"
    old "Track 13. Sea of nectar"
    new "13. El mar de néctar"
    old "Track 3. Mare tranquillitatis\nTrack 7. Unknown mist"
    new "03. El mar de la calma\n07. Niebla desconocida"
    old "Track 8. Lush garden\nTrack 9. Jormungandr"
    new "08. Exuberante jardín\n09. Jörmungandr"
    old "Credits"
    new "Créditos"
    ...
    new "Discouraged Workers ©2020 YGGDRASIL STUDIO Co, Pte. All Rights Reserved. All literary works/trademarks are property of their respective owners. Do not distribute our program or any alterations of our program files. For the End User License Agreement, please view the EULA.txt file in the licenses directory, or visit {a=https://github.com/YGGDRASIL-STUDIO/Discouraged-Workers/blob/gh-pages/EULA.txt}here{/a}.\n\nThe source code of Discouraged Workers is covered by the terms of the GNU Lesser General Public License v3.0. The source code can be found {a=https://github.com/YGGDRASIL-STUDIO/Discouraged-Workers/tree/source-codes}here{/a}.\n"
    ...
    new "This program contains free font software under a number of licenses, including the SIL Open Font License. A complete list of font software, including links to download can be found {a=https://github.com/YGGDRASIL-STUDIO/Discouraged-Workers/wiki/about#licenses}here{/a}, or please view the fonts-LICENSE.txt file in the licenses directory.\n\nThis program contains a number of assets that are covered by the terms of the Creative Commons License. For a list of assets, and a location where the original assets can be downloaded from, please view the assets-LICENSE.txt file in the licenses directory or visit {a=https://github.com/YGGDRASIL-STUDIO/Discouraged-Workers/wiki/about#licenses}here{/a}.\n"
    ...
    new "This program contains Xbox 360 Controller/Button images. The asset pack can be found {a=http://xbox.create.msdn.com/en-us/education/catalog/utility/controller_buttons}here{/a}.\n"
    ...
    new "©2020 Valve Corporation. Steam y el logo de Steam son marcas y/o marcas registradas de Valve Corporation en los E.E.U.U. y/u otros países.\n\n©2020 Valve Corporation. Steamworks y el logo de Steamworks son marcas y/o marcas registradas de Valve Corporation en los E.E.U.U. y/u otros países."
