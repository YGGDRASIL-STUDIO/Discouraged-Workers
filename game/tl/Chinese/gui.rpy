translate Chinese python:
    ...
    config.translations['Automatic saves'] = u'一个自动保存的页面'
    config.translations['Quick saves'] = u'一个快速保存的页面'
    ...
    build_date = "2018年2月26日"
    copyright = "(c)2018 YGGDRASIL STUDIO"
    gui.attention = "警     告"
    ...
    gui.about = "Discouraged Workers (c)2018 YGGDRASIL STUDIO Co, Pte。拥有所有权利。失望失业者的著作权归YGGDRASIL STUDIO所有。所有的著作/商标都属于所有者的财产。请禁止传播本公司的程序(program)及利用本公司程序(program)进行变更的程序(program)文件。最终用户的使用权合同请参考licenses目录的EULA.txt文件或{a=https://github.com/YGGDRASIL-STUDIO/Discouraged-Workers/blob/gh-pages/EULA.txt}请访问此处{/a}"
    ...
    valve.license = "(c)2018 Valve Corporation。Steam 和 Steam 徽标均为 Valve Corporation 在美国和/或其他国家（地区）的商标和/或注册商标。\n\n(c)2018 Valve Corporation。Steamworks 和 Steamworks 徽标均为 Valve Corporation 在美国和/或其他国家（地区）的商标和/或注册商标。"
