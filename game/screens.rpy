            ...
            button xsize 256:
                vbox xalign .5:
                    ...
                    textbutton ('{size=[gui.interface_text_size]}[gui.right]{/size}') action [SetVariable('go', 1), SetVariable('gocount', 6), Jump('bridge_control')] at menuback:
                        xalign .5
    if gocount == -2:
        key 'pad_leftx_neg' action [SetVariable('gocount', -3), Jump('bridge_control')]
        key 'pad_leftx_pos' action [SetVariable('gocount', 1), Jump('bridge_control')]
        key 'K_LEFT' action [SetVariable('gocount', -3), Jump('bridge_control')]
        key 'K_RIGHT' action [SetVariable('gocount', 1), Jump('bridge_control')]
    elif gocount == -1:
        key 'pad_leftx_neg' action [SetVariable('gocount', -2), Jump('bridge_control')]
        key 'pad_leftx_pos' action [SetVariable('gocount', 1), Jump('bridge_control')]
        key 'K_LEFT' action [SetVariable('gocount', -2), Jump('bridge_control')]
        key 'K_RIGHT' action [SetVariable('gocount', 1), Jump('bridge_control')]
    elif gocount == 0:
        key 'pad_leftx_neg' action [SetVariable('gocount', -1), Jump('bridge_control')]
        key 'pad_leftx_pos' action [SetVariable('gocount', 1), Jump('bridge_control')]
        key 'K_LEFT' action [SetVariable('gocount', -1), Jump('bridge_control')]
        key 'K_RIGHT' action [SetVariable('gocount', 1), Jump('bridge_control')]
    elif gocount == 1 or gocount == -4:
        key 'pad_leftx_neg' action [SetVariable('gocount', -1), Jump('bridge_control')]
        key 'pad_leftx_pos' action [SetVariable('gocount', 2), Jump('bridge_control')]
        key 'K_LEFT' action [SetVariable('gocount', -1), Jump('bridge_control')]
        key 'K_RIGHT' action [SetVariable('gocount', 2), Jump('bridge_control')]
    elif gocount == 2 or gocount == -5:
        key 'pad_leftx_neg' action [SetVariable('gocount', -4), Jump('bridge_control')]
        key 'pad_leftx_pos' action [SetVariable('gocount', 3), Jump('bridge_control')]
        key 'K_LEFT' action [SetVariable('gocount', -4), Jump('bridge_control')]
        key 'K_RIGHT' action [SetVariable('gocount', 3), Jump('bridge_control')]
    elif gocount == 3 or gocount == -6:
        key 'pad_leftx_neg' action [SetVariable('gocount', -5), Jump('bridge_control')]
        key 'pad_leftx_pos' action [SetVariable('gocount', 4), Jump('bridge_control')]
        key 'K_LEFT' action [SetVariable('gocount', -5), Jump('bridge_control')]
        key 'K_RIGHT' action [SetVariable('gocount', 4), Jump('bridge_control')]
    elif gocount == 4 or gocount == -7:
        key 'pad_leftx_neg' action [SetVariable('gocount', -6), Jump('bridge_control')]
        key 'pad_leftx_pos' action [SetVariable('gocount', 5), Jump('bridge_control')]
        key 'K_LEFT' action [SetVariable('gocount', -6), Jump('bridge_control')]
        key 'K_RIGHT' action [SetVariable('gocount', 5), Jump('bridge_control')]
    elif gocount == 5:
        key 'pad_leftx_neg' action [SetVariable('gocount', -7), Jump('bridge_control')]
        key 'pad_leftx_pos' action [SetVariable('gocount', 6), Jump('bridge_control')]
        key 'K_LEFT' action [SetVariable('gocount', -7), Jump('bridge_control')]
        key 'K_RIGHT' action [SetVariable('gocount', 6), Jump('bridge_control')]
screen wallet:
    hbox xpos .6 ypos .65:
